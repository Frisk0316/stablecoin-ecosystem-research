...
- **Holder yield 是少數高度一致的維度**：GENIUS、MiCA ART、MiCA EMT、BoE（CBD 部分）都用不同技術壓低 holder yield；NYDFS 透過儲備組成限制間接達成。
- **Significant-token 是另一個顯著差異點**：美國目前沒有 significant tier；歐盟與英國各有不同型態的「規模門檻 → 額外義務」設計。
- 提醒讀書會：談「跨境等價（equivalence）」時，這六維比較表只是基線；正式判斷仍取決於 GENIUS Section 18 的 Treasury comparability / registration / U.S. liquidity screen。
...
| --- | --- | --- | --- | --- | --- |
| 適格發行者 | `CLAIM_082`, `CLAIM_083`, `CLAIM_126` | `CLAIM_094` | `CLAIM_097`, `CLAIM_127`, `CLAIM_129` | `CLAIM_088`, `CLAIM_090`, `CLAIM_130` | `CLAIM_036` |
| 儲備組成 | `CLAIM_084` | `CLAIM_069`, `CLAIM_094` | `CLAIM_043` | `CLAIM_090` | `CLAIM_039` |
| 贖回權 | `CLAIM_084` | `CLAIM_070`, `CLAIM_095` | `CLAIM_042`, `CLAIM_122`, `CLAIM_124` | `CLAIM_089`, `CLAIM_131` | `CLAIM_038` |
| 破產／清算 | `CLAIM_087` | `CLAIM_095`, `CLAIM_096` | `CLAIM_097` | `CLAIM_089` | `CLAIM_040` |
| 持有人收益 | `CLAIM_086` | `CLAIM_071` | `CLAIM_128` | `CLAIM_090` | n/a |
| Significant-token 門檻 | n/a | `CLAIM_094` | `CLAIM_097`, `CLAIM_129` | `CLAIM_091`, `CLAIM_130` | n/a |
